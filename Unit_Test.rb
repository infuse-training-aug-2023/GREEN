...
class TestAverage < Test::Unit::TestCase
  ...
  def test_open_website
    ...
    assert_equal(nil, test_creation_selenium.open_website("http://127.0.0.1:5500/test/index.html"))
  ...
  def test_set_wait
    test_creation_selenium = SeleniumWrapper.new
    test_creation_selenium.open_website("http://127.0.0.1:5500/test/index.html")
